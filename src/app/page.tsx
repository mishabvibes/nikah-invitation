...
export default function WeddingInvitation() {
  ...
  const nikahEvent: CalendarEvent = {
    title: 'Thahseena & Fayis - Nikah Ceremony',
    startDate: '20251004T093000',
    endDate: '20251004T113000',
  ...
  const walimaEvent: CalendarEvent = {
    title: 'Thahseena & Fayis - Walima Reception',
    startDate: '20251004T120000',
    endDate: '20251004T150000',
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-emerald-100 py-8 px-4">
      <div className="max-w-sm mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-6">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-7 gap-1 text-center text-xs">
              <div className="text-gray-500 py-2 font-medium" style={{ fontFamily: 'Playfair Display, serif' }}>
                SUN
              </div>
              <div className="text-gray-500 py-2 font-medium" style={{ fontFamily: 'Playfair Display, serif' }}>
                MON
              ...
              <div className="py-2"></div>
              <div className="py-2"></div>
              <div className="py-2 text-gray-600" style={{ fontFamily: 'Playfair Display, serif' }}>
                1
              </div>
              <div className="py-2 text-gray-600" style={{ fontFamily: 'Playfair Display, serif' }}>
                2
              ...
              <div
                className="py-2 bg-gradient-to-r from-emerald-500 to-amber-500 text-white rounded-full w-6 h-6 flex items-center justify-center mx-auto font-bold shadow-lg relative"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
                4
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <div className="w-8 h-8 flex items-center justify-center text-amber-600">🍽️</div>
            </div>
